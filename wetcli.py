...
wetcli_parser.add_argument('-d', action='store',type=str, help='name of the folder to be uploaded', default=None)
wetcli_parser.add_argument('-f', action='store',type=str, help='name of the file to be uploaded', default=None)
wetcli_parser.add_argument('-m', action='store',type=str, help='custom message', default=default_message)
